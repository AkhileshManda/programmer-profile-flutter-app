        ...
        body: SafeArea(
          child: Stack(
            children: [
              ...
              widget.notifcations.isNotEmpty
                  ? Column(
                      children: [
                        Padding(
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (ctx, index) {
                                return ListTile(
                                    ...
                                    title: Text(
                                        widget.notifcations[index].description),
                                    leading: widget.notifcations[index]
                                                .otherUser.profile !=
                                            null
                                    ...
                                    trailing: SizedBox(
                                      ...
                                      child: IconButton(
                                        onPressed: () {
                                          //print("mark as read");
                                          NotificationAPIs().markAsRead(
                                              widget.notifcations[index].id);
                                        },
                      ...
                      children: [
                        Center(
                          child: LottieBuilder.asset(
                              "assets/images/4021-no-notification-state.json",
                              height: 250),
                        ),
                        const Text(
